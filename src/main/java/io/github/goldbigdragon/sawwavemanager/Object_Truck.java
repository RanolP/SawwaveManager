...
public class Object_Truck
{
	...
	public synchronized void isAllReady()
	{
		if(Ready_OverView&&Ready_Netwrok)
		{
			...
			Ready_Netwrok = false;
			Main.BufferStore.add(new SimpleDateFormat("yyyy-MM-dd-hh-mm-ss").format(new Date()).toString() +"¡Ú"+ Type+"¡Ú"+Main.Distance.getText()+"¡Ú"+Tx_Power+"¡Ú"+Bandwidth+"¡Ú"+Channel+"¡Ú"+RSSI+"¡Ú"+Tx_Rate+"¡Ú"+Rx_Rate+"¡Ú"+CCQ);
